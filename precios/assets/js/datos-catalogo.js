...
(function (global) {
  ...
  var categorias = [
    {codigo:'MAT-01', grupo:'MAT', nombre:'Agregados y áridos',                  desc:'Arena, grava, caliche, piedra y polvo de piedra.'},
    {codigo:'MAT-02', grupo:'MAT', nombre:'Cemento, morteros y aditivos',        desc:'Cemento, cal, pegamentos, derretido y aditivos.'},
    {codigo:'MAT-03', grupo:'MAT', nombre:'Hormigón premezclado',                desc:'Por resistencia, variantes y servicio de bombeo.'},
    {codigo:'MAT-04', grupo:'MAT', nombre:'Acero de refuerzo y metales',         desc:'Varillas, mallas, perfilería y planchas.'},
    {codigo:'MAT-05', grupo:'MAT', nombre:'Bloques y prefabricados',             desc:'Bloques, ladrillos, adoquines y prefabricados.'},
    {codigo:'MAT-06', grupo:'MAT', nombre:'Madera y encofrado',                  desc:'Pino de encofrado, plywood y maderas tratadas.'},
    {codigo:'MAT-07', grupo:'MAT', nombre:'Techos e impermeabilización',         desc:'Zinc, aluzinc, tejas, mantos y aislamientos.'},
    {codigo:'MAT-08', grupo:'MAT', nombre:'Pisos y revestimientos',              desc:'Cerámica, porcelanato, piedra natural y topes.'},
    {codigo:'MAT-09', grupo:'MAT', nombre:'Plomería, sanitarios y gas',          desc:'Tuberías, accesorios, aparatos, grifería y bombas.'},
    {codigo:'MAT-10', grupo:'MAT', nombre:'Electricidad e iluminación',          desc:'Cables, canalización, paneles, luminarias y respaldo.'},
    {codigo:'MAT-11', grupo:'MAT', nombre:'Puertas, ventanas y cristales',       desc:'Puertas, ventanas de aluminio, cristales y herrajes.'},
    {codigo:'MAT-12', grupo:'MAT', nombre:'Pintura y acabados',                  desc:'Acrílicas, esmaltes, selladores y especiales.'},
    {codigo:'MAT-13', grupo:'MAT', nombre:'Plafones y construcción liviana',     desc:'Yeso, perfilería, plafones y consumibles de drywall.'},
    {codigo:'MAT-14', grupo:'MAT', nombre:'Ferretería y fijaciones',             desc:'Clavos, tornillos, anclajes, selladores y abrasivos.'},
    {codigo:'MAT-15', grupo:'MAT', nombre:'Climatización y ventilación',         desc:'Equipos de A/A, ductos, rejillas y refrigeración.'},
    {codigo:'MAT-16', grupo:'MAT', nombre:'Sistemas especiales',                 desc:'CCTV, redes, detección de incendio y control de acceso.'},
    {codigo:'MAT-17', grupo:'MAT', nombre:'Seguridad industrial y señalización', desc:'EPP y señalización de obra.'},
    {codigo:'MAT-18', grupo:'MAT', nombre:'Exteriores y paisajismo',             desc:'Grama, tierra, plantas y riego.'},
    {codigo:'MOS-01', grupo:'MOS', nombre:'Mano de obra por oficio',             desc:'Jornales diarios por oficio.'},
    {codigo:'MOS-02', grupo:'MOS', nombre:'Subcontratos por partida',            desc:'Precio unitario de ejecución, solo mano de obra.'},
    {codigo:'MOS-03', grupo:'MOS', nombre:'Servicios profesionales',             desc:'Diseño, cálculo, topografía, supervisión y tasación.'},
    {codigo:'MOS-04', grupo:'MOS', nombre:'Trámites y permisos',                 desc:'Licencias, no objeciones y conexiones de servicios.'},
    {codigo:'MOS-05', grupo:'MOS', nombre:'Servicios de obra y logística',       desc:'Demolición, movimiento de tierra, bote, fletes y limpieza.'},
    {codigo:'EQU-01', grupo:'EQU', nombre:'Maquinaria pesada',                   desc:'Alquiler con operador.'},
    {codigo:'EQU-02', grupo:'EQU', nombre:'Equipos de construcción',             desc:'Equipos de obra en alquiler.'},
    {codigo:'EQU-03', grupo:'EQU', nombre:'Andamiaje y formaleta',               desc:'Andamios, puntales y formaleta en alquiler.'},
    {codigo:'EQU-04', grupo:'EQU', nombre:'Herramientas y equipo menor',         desc:'Herramienta de compra.'}
  ];
